...
// 
export const defaultAppMouseMode/*: Input.CloudLark.IAppMouseMode*/ = {
	mouseShow: true, mouseLock: false, mouseRelative: false, 
	rect: {
...
export const DefaultState/*: RootState*/ = {
    ...
    container: {
        marginTop: 0, marginLeft: 0, width: 0, height: 0
    },
    appSize: {
        width: Config.OriginW,
        height: Config.OriginH
    },
    iceState: IceState.DISCONNECT,
    utLockInfo: {
        checkUtLockMessage: '',
        checkUtLockResult: false,
        remainMinutes: 0,
    },
    screenOrientation: 'portrait',
    scaleMode: ScaleMode.CONTAIN_APP,
    isFullScreen: false,
    isLockMouse: false,
    ...
    vkeyboard: false,
    modalSetup: false,
    ui: LocalizationLoader.ui,
    appState: APP_STATE.BEFORE_CREATE,
    renderMode: RenerMode.VIDEO,
    appMouseMode: defaultAppMouseMode,
    syncApp: false,
    remoteScreenReady: false,
    initCursorMode: false,
    waterMark: false,
    bgColor: "#0000000f",
    menu: false,
