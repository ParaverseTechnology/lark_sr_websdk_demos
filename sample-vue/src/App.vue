<template>
  <div id="app" ref="appContainer">
      <h1 style="position:absolute;z-index: 1000;">Your components here</h1>
      <!-- PxyCommonUI 组件容器 -->
...
export default {
  ...
  mounted() {
    ...
    console.log("ref", this.$refs["appContainer"], this.$refs["uiContainerRef"]);
    ...
    if (Capabilities.isMobile) {
      ...
      this.joystick = new Joystick({
        // 必填项，挂载的根元素
        rootElement: this.$refs["uiContainerRef"], 
